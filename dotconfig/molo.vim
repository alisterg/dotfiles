...
let s:bg_contrast     = { "gui": "#373c4a", "cterm": "232" } " bg contrast
let s:lighter_gray    = { "gui": "#D5D9E2", "cterm": "251" } " fg 
let s:medium_gray     = { "gui": "#5c6370", "cterm": "243" } " comments
let s:orange          = { "gui": "#e5c07b", "cterm": "167" } " orange
let s:dark_orange     = { "gui": "#F88555", "cterm": "167" } " orange
let s:yellow          = { "gui": "#F3F99D", "cterm": "11"  } " yellow
let s:dark_green      = { "gui": "#98c379", "cterm": "2"   } " green
let s:light_green     = { "gui": "#59F78D", "cterm": "10"  } " light cyan
let s:light_blue      = { "gui": "#99ECFE", "cterm": "153" } " dark cyan
let s:blue            = { "gui": "#57C7FF", "cterm": "12"  } " blue
let s:dark_purple     = { "gui": "#9A86EE", "cterm": "134" } " magenta
...
let s:dark_red        = { "gui": "#FF5B56", "cterm": "1"   }
...
call s:h("Cursor",        {"bg": s:white, "fg": s:norm })
...
call s:h("Identifier",    {"fg": s:light_purple, "cterm": "italic", "gui": "italic" })
...
call s:h("typeScriptPredefinedType ",    {"fg": s:dark_purple})
hi! link typeScriptEnum typeScriptPredefinedType
...
call s:h("markdownH4", {"fg": s:light_blue})
call s:h("markdownH4Delimiter", {"fg": s:dark_green})
call s:h("markdownH5", {"fg": s:lighter_gray})
call s:h("markdownH5Delimiter", {"fg": s:dark_green})
call s:h("markdownH6", {"fg": s:lighter_gray})
call s:h("markdownH6Delimiter", {"fg": s:dark_red})

call s:h("htmlTagName",     {"fg": s:light_blue})
"call s:h("htmlString",     {"fg": s:dark_green})
call s:h("htmlTagN",     {"fg": s:orange})

call s:h("Operator",      {"fg": s:norm, "cterm": "bold", "gui": "bold"})

call s:h("PreProc",     {"fg": s:light_purple})
...
call s:h("Special",       {"fg": s:light_blue})
...
if has("gui_running")
  ...
  call s:h("SpellRare",   {"gui": "underline", "sp": s:light_blue})
  call s:h("SpellLocal",  {"gui": "underline", "sp": s:dark_green})
else
  call s:h("SpellBad",    {"cterm": "underline", "fg": s:red})
  call s:h("SpellCap",    {"cterm": "underline", "fg": s:light_green})
  call s:h("SpellRare",   {"cterm": "underline", "fg": s:light_blue})
