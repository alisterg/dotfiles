...
let s:medium_gray     = { "gui": "#a1a1a1", "cterm": "243" }
let s:white           = { "gui": "#F1F1F1", "cterm": "15"  }
let s:actual_white    = { "gui": "#FFFFFF", "cterm": "231" }
let s:subtle_black    = { "gui": "#303030", "cterm": "236" }
let s:light_black     = { "gui": "#262626", "cterm": "235" }
let s:lighter_black   = { "gui": "#787878", "cterm": "239" }
let s:light_gray      = { "gui": "#a7a7a7", "cterm": "248" }
let s:lighter_gray    = { "gui": "#dfdfdf", "cterm": "251" }
let s:lightest_gray   = { "gui": "#EEEEEE", "cterm": "255" }
let s:pink            = { "gui": "#69D5E2", "cterm": "9"   }
let s:dark_red        = { "gui": "#C30771", "cterm": "1"   }
let s:light_red       = { "gui": "#E32791", "cterm": "1"   }
let s:orange          = { "gui": "#D75F5F", "cterm": "167" }
let s:darker_blue     = { "gui": "#005F87", "cterm": "18"  }
let s:dark_blue       = { "gui": "#008EC4", "cterm": "32"   }
let s:blue            = { "gui": "#9A86EE", "cterm": "12"  }
let s:light_blue      = { "gui": "#9AD763", "cterm": "153" }
let s:dark_cyan       = { "gui": "#20A5BA", "cterm": "6"   }
let s:light_cyan      = { "gui": "#4FB8CC", "cterm": "14"  }
let s:dark_green      = { "gui": "#10A778", "cterm": "2"   }
let s:light_green     = { "gui": "#5FD7A7", "cterm": "10"  }
let s:dark_purple     = { "gui": "#af5fd7", "cterm": "134" }
let s:light_purple    = { "gui": "#F88555", "cterm": "140" }
...
function! s:h(group, style)
  execute "highlight" a:group
    ...
    \ "ctermbg=" (has_key(a:style, "bg")    ? "NONE" : "NONE")
...
call s:h("typeScriptRepeat",    {"fg": s:blue})
...
call s:h("Search",        {"bg": s:light_green, "fg": s:red})
